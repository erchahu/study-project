    ...
    <>
      ...
      <Canvas style={{ width, height: 300, backgroundColor: '#9bf5b9' }}>
        <Rect
          ...
          color="#61DAFB"
        >
          <CornerPathEffect r={164} />
        </Rect>
      </Canvas>
      <Canvas style={{ width, height: 300, backgroundColor: '#f29bf5' }}>
         <Group transform={[{ scale: 0.3 }]}>
      ...
      <Canvas style={{ width, height: 300, backgroundColor: '#f29bf5' }}>
         <Group transform={[{ scale: 0.3 }]}>
          <Path path={logo} color="#61DAFB"  style="stroke" strokeWidth={15}>
            <Line2DPathEffect
              width={0}
              matrix={processTransform2d([{ scale: 2 }])}
            />
          </Path>
         </Group>
      </Canvas> 
...
export default memo(PathEffectsDemo)
